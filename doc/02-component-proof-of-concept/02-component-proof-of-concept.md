...
I chose StockTracker because it aligns with my interest in Financial Technology and seems realistic to implement within the timeframe and constraints given. It has real world use as investors can use it to track holdings, and remains simple but meaningful. It can also grow later into tracking more aspects of a stock without deviating from the core concept. It seems more interesting and unique compared to the other components I came up with.
